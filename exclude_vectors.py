...
def main_procesing_corpus(korpus: str, size : int):
    ...
    f=open(r"C:\Users\tymon.czarnota\Desktop\PADT1\output_{}_{}_WHOLE.tsv".format(korpus,size),'w', encoding ='utf-8')
    ff=open(r"C:\Users\tymon.czarnota\Desktop\PADT1\output_{}_{}_WHOLE_META.tsv".format(korpus,size),'w',encoding = 'utf-8')
